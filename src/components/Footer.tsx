// Footer Component
// Generated: 2025-09-04T09:03:41.189Z
...
export default function Footer() {
  ...
  const socialLinks = [
    { name: "Twitter", icon: Twitter, href: "https://twitter.com/swiftinvoice" },
    { name: "Facebook", icon: Facebook, href: "https://facebook.com/swiftinvoice" },
    { name: "LinkedIn", icon: Linkedin, href: "https://linkedin.com/company/swiftinvoice" },
    { name: "GitHub", icon: Github, href: "https://github.com/swiftinvoice" }
  ]

  const features = [
    { icon: Clock, text: "Lightning-fast invoicing" },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <Link href="/" className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-bold text-xl text-foreground">SwiftInvoice</span>
              </Link>
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                The fastest way to create, send, and manage professional invoices. 
                Trusted by thousands of businesses worldwide for streamlined billing and payments.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">support@swiftinvoice.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <Phone className="size-4 text-primary flex-shrink-0" />
                <span className="text-muted-foreground">+1 (555) 123-SWIFT</span>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span>© 2024 SwiftInvoice. All rights reserved.</span>
