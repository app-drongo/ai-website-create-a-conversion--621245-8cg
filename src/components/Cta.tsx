...
export default function Cta() {
  const stats = [
    ...
    { value: "2 Min", label: "Average Setup", icon: Zap },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join thousands of freelancers and small businesses who trust SwiftInvoice 
                for their billing needs. Create your first invoice in under 2 minutes.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                No complex setup - start invoicing immediately
              </p>
            </div>
          </div>
        </div>
